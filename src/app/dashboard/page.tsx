  ...
  return (
    <div className="fade-in" style={{ maxWidth: "1280px", margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px", marginBottom: "32px" }}>
        {[
          { label: "Total Notes", value: notesCount, icon: "description", color: "#D946EF", href: "/dashboard" },
          { label: "Pending Reminders", value: remindersCount, icon: "notifications_active", color: "#34D399", href: "/dashboard/reminders" },
          { label: "Overdue", value: overdueCount, icon: "crisis_alert", color: "#ffb4ab", href: "/dashboard/reminders" },
          { label: "Tags", value: tagsCount, icon: "sell", color: "#c0c1ff", href: "/dashboard/tags" },
          ...
          <Link
            ...
            onMouseEnter={(e) => {
              ...
              (e.currentTarget as HTMLElement).style.boxShadow = `4px 4px 0 0 ${color}`;
            }}
            onMouseLeave={(e) => {
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: "24px" }} className="dashboard-grid">
        ...
        <div style={cardStyle}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "2px solid rgba(255,255,255,0.15)", paddingBottom: "12px", marginBottom: "20px" }}>
            ...
            <Link href="/dashboard" style={{ fontFamily: "JetBrains Mono", fontSize: "11px", color: "#34D399", textDecoration: "none", letterSpacing: "0.05em" }}>
              VIEW ALL →
            </Link>
          </div>
          ...
          {recentNotes.length === 0 ? (
            <div style={{ textAlign: "center", padding: "40px 0" }}>
              ...
              <Link href="/dashboard" style={{ fontFamily: "JetBrains Mono", fontSize: "11px", color: "#34D399", textDecoration: "none", marginTop: "8px", display: "inline-block" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {recentNotes.map((note) => (
                <Link
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.2)"; (e.currentTarget as HTMLElement).style.backgroundColor = "rgba(255,255,255,0.03)"; }}
